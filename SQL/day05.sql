...
--toptancilar  tablosunda irtibat_ismi 'Adem Cos' olan sirket_ismi ile güncelleyiniz.
...
update malzemeler set musteri_ismi=(select irtibat_ismi from toptancilar where sirket_ismi = 'Apple') where malzeme_ismi = 'Laptop';
select * from malzemeler;
...
INSERT INTO meslekler VALUES(2, 'Veli', 'Cem', 'Muhendis', '18000');
...
select * from meslekler;--normal haliyle gormek icin her seferinde calistiriyoruz.
...
select * from musteriler ORDER BY maas DESC offset 2 limit 5;-- offset 2==> 2 kisiyi atla demek. 
...
--INTERSECT : iki sorgu ifadesinin kesisim degerini bize verir- ortak olanlari verir

--EXCEPT : ilk sorguda olup ikinci sorguda olmayan degerleri bize verir-ortak olanlari alir, haricleri verir.
...
intersect 
select isim,sehir from isciler where sehir<>'Istanbul'; --murat oz'lerden istanbul olanlar haric.
...
select isim,sehir from isciler where sehir<>'Istanbul';  --murat ozlerden istanbul olanlar.
