...
ogrenci ismi sütunu küçük harf karakter alamasın ve bu kısıtlamanın
...
--ali can kaydının idsini 50 yap
...
update ogrenci_info set ogr_id = ogr_yas+ogr_id where ogr_kayit='01.08.2021';
select * from ogrenci_info;
...
--SORU10:Adres değeri Florida olmayan kaydı siliniz. esit degildir==> " <> ""
